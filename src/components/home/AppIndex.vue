<template>
  <div>
    ...
    <br/><br/>
    <el-link type="warning" href="/login">返回登录</el-link>
  ...
  export default {
    ...
    methods: {
      loadData() {
        ...
        axios.post('/list',qs.stringify(param)).then((result) => {
...
/*        var  params = {
        ...
        axios.post("/delUser", qs.stringify(params)).then((result) => {
      ...
      addSubmit() {
        ...
        this.$refs.addFormData.validate((valid) => {
          ...
          if (valid) {
            ...
            axios.post("/addUser", qs.stringify(param)).then((result) => {
              if (result.data.success) {
                this.$message({
                  type: 'info',
                  message: '添加成功',
